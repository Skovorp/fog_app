...
enum SessionExport {
    ...
    static func generateAllJSON(_ sessions: [Session], fallbackDevice: DeviceInfo) throws -> URL {
        ...
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("feral_sessions_\(filenameStamp()).json")
    ...
    static func generateAllVideosZIP(_ sessions: [Session]) throws -> URL {
        ...
        let stagingDir = fm.temporaryDirectory
            .appendingPathComponent("feral_videos_staging_\(UUID().uuidString)")
        ...
        let dest = fm.temporaryDirectory
            .appendingPathComponent("feral_videos_\(filenameStamp()).zip")
    ...
    static func generateAllPDF(_ sessions: [Session]) throws -> URL {
        ...
        let intermediateURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("feral_sessions_intermediate_\(UUID().uuidString).pdf")
        ...
        let finalURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("feral_sessions_\(filenameStamp()).pdf")
    ...
    private static func combinedPDFFormat(count: Int) -> UIGraphicsPDFRendererFormat {
        ...
        format.documentInfo = [
            kCGPDFContextTitle as String: "feral: parkinson's — \(count) sessions",
